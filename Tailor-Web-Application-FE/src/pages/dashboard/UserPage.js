...
export default function UserPage() {
  ...
  const filteredUsers = applySortFilter(tailorList, getComparator(order, orderBy), filterName);
  ...
  return (
    <>
      ...
      >
        <MenuItem
>
          <Iconify icon={'eva:edit-fill'} sx={{ mr: 2 }} onClick = {onAddClick}/>
          Edit
        </MenuItem>
        ...
        {showModal && <AdminUserModal open={showModal} onClose={handleOnClose} content={account}/>}
        ...
        {showConfirmation && (
          <BasicModal
            ...
            title={"Sigur doresti sa stergi acest user ?"}
